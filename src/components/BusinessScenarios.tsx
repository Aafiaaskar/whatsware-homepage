...
const scenarios = [
  ...
  },
  {
    ...
    route: "/solutions/health-wellness",
    icon: Cross,
  ...
  },
  {
    ...
    route: "/solutions/restaurant-food",
                ...
                >
                  ...
                  <div
                    ...
                    onPointerUp={(e) => {
                      ...
                      // Prevent Embla from treating the interaction as a drag
                      e.stopPropagation();
                    ...
                    className={`group relative h-full min-h-[500px] cursor-pointer overflow-hidden rounded-[2rem] border border-black/5 ${item.bg} p-8 shadow-sm transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl`}
                  >
                    {/* Decorative glow */}
                    ...
                    <div className="relative mt-8 flex h-40 items-center justify-center overflow-hidden rounded-2xl bg-white/40 backdrop-blur-sm">
                      <div className="absolute h-28 w-28 rounded-full bg-white/60 blur-xl transition-all duration-700 group-hover:h-36 group-hover:w-36" />
                    ...
                    {/* Decorative dots */}
                    <div className="pointer-events-none absolute bottom-7 right-7 h-2 w-2 animate-pulse rounded-full bg-white/80" />

                    <div className="pointer-events-none absolute bottom-12 right-12 h-1.5 w-1.5 animate-pulse rounded-full bg-white/60" />
                  </div>
                </div>
              );
            })}
          ...
          <span className="text-xs font-medium text-gray-400">
            {isPaused
              ? isTamil
                ...
                : "Paused"
              : isTamil
                ? "தொழில்துறைகளை தானாக ஆராய்கிறது"
                : "Automatically exploring industries"}
          </span>
        </div>
      </div>
    </section>
