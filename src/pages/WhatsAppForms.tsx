            ...
            <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-20">
              ...
              <div>
                ...
                <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                  ...
                  >
                    {isTamil ? "Get Started" : "Get Started"}
                  ...
                  >
                    {isTamil ? "Book a Demo" : "Book a Demo"}
                  </Link>
    ...
    <div className="relative mx-auto w-full max-w-xl">
      ...
      <div className="relative rounded-[2rem] border border-[#D6E8DF] bg-white p-5 shadow-[0_40px_100px_-30px_rgba(12,75,52,0.45)] sm:p-7">
        ...
        <div className="mt-4 flex gap-3">
          ...
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#D9F8ED] text-[#159447]">
            <Sparkles className="h-4 w-4" />
          </div>
        ...
        <div className="mt-5 rounded-2xl border border-[#DCEAE4] bg-[#F8FBF9] p-5">
          ...
          <button
            type="button"
            className="mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-[#075E54] py-3 text-xs font-black text-white"
          >
            Submit Details
