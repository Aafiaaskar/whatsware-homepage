    ...
    <div className="min-h-screen overflow-hidden bg-white text-slate-900">
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-[1fr_0.9fr]">
                  ...
                  <div className="relative rounded-2xl bg-slate-950 p-4 text-white shadow-xl">
                    ...
                    <div className="relative">
                      <div className="flex items-center gap-2">
                        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#159447]">
                          <Bot size={18} />
                        </div>

                        <div>
                          <p className="text-xs font-bold">Whatsware AI</p>
        ...
        <div className="mx-auto max-w-7xl px-5 py-8 sm:px-8 lg:px-10">
          <div className="flex flex-col items-center justify-between gap-5 sm:flex-row">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {["E-commerce", "Education", "Restaurants", "Services"].map(
                (item) => (
                  <span
                    key={item}
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          <div className="mb-12 max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">
              ...
              <span className="block">conversations automatically.</span>
            </h2>
          </div>
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.05] p-4 shadow-2xl backdrop-blur-xl sm:p-6">
                <div className="flex items-center justify-between border-b border-white/10 pb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold">Whatsware AI Agent</p>
                      <p className="text-[10px] text-green-400">
          ...
          >
            <div className="grid items-center gap-4 md:grid-cols-[1fr_auto_1fr_auto_1fr]">
              ...
              <div className="rounded-3xl border border-pink-100 bg-gradient-to-br from-pink-50 to-purple-50 p-7 text-center">
                ...
                <h3 className="mt-5 font-black">Instagram</h3>
              ...
              <div className="rounded-3xl border border-green-100 bg-green-50 p-7 text-center shadow-xl shadow-green-100/50">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[#159447] text-white shadow-lg shadow-green-600/20">
                  <Bot size={29} />
                </div>

                <h3 className="mt-5 font-black">Whatsware AI</h3>
                <p className="mt-2 text-xs leading-5 text-slate-500">
              ...
              <div className="rounded-3xl border border-green-100 bg-gradient-to-br from-green-50 to-emerald-50 p-7 text-center">
                ...
                <h3 className="mt-5 font-black">WhatsApp</h3>
                <p className="mt-2 text-xs leading-5 text-slate-500">
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          <div className="grid items-center gap-14 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            >
              ...
              <h2 className="mt-4 text-3xl font-black tracking-tight sm:text-5xl">
                Don't just collect
                <span className="block text-[#159447]">engagement.</span>
                Capture intent.
              </h2>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-black tracking-tight sm:text-5xl">
              ...
              <span className="block">A better way to sell.</span>
            </h2>
          </div>
      ...
      <section className="px-5 py-20 sm:px-8 sm:py-28 lg:px-10">
        ...
        >
          ...
          <div className="relative">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 text-white shadow-xl">
              <Instagram size={28} />
            </div>
      ...
      <section className="pb-24 sm:pb-32">
        <div className="mx-auto max-w-4xl px-5 sm:px-8">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-3xl font-black tracking-tight sm:text-5xl">
              Questions?
              <span className="block text-[#159447]">We've got answers.</span>
            </h2>
          </div>
